...
class Pattern_page(tk.Frame):
    def __init__(self, parent, controller):
        ...
        self.square_icon = ImageTk.PhotoImage(Image.open(self.constants.SQUARE).resize((40, 40)))
        self.hexagon_icon = self.create_hexagon_icon(40, outline_color="black")
        self.triangle_icon = ImageTk.PhotoImage(Image.open(self.constants.TRIANGLE).resize((40, 40)))
        ...
        self.hex = self.hexagon.HexagonShape(self.canvas, fill=self.constants.text_color, outline=self.constants.text_color)
