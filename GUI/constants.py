...
info_text = [
    {
        "heading": "Hej! \nJag är Balansroboten. \nÄven fast jag är en robot så är \ndu och jag ganska lika.", 
    ...
    {
        "heading": "Mina ögon",
        "subheading": "\nJag har ögon precis som du. Men istället \nför ögon har jag en kamera. Kameran \nanvänder jag för att se bollen.",
        "body": "\nKameran filmar balansplattan med 90 bilder i sekunder. Med hjälp \nav bilderna kan en datoralgoritm identifiera bollen från dess form och färg. Algoritmen räknar sedan ut bollens position på balansplattan. Du kan se vad kameran ser i rutan till vänster.",
    },
    {
        "heading": "Mina muskler",
        "subheading": "\nJag har även muskler för att kunna röra på plattan.",  
    ...
    {
        "heading": "Min Hjärna",
        "subheading": "\nJag har också en hjärna. Men till skillnad från dig är min hjärna en liten dator.",  
